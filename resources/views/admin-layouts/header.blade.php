            ...
            <div class="page-title d-flex flex-column me-5">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('admin-main') }}" class="text-muted text-hover-primary">Home</a>
                    </li>
                    <!--end::Item-->

                    @foreach ($breadcumbs as $bItem)
                        <!--begin::Item-->
                        ...
                        <li class="breadcrumb-item text-dark">
                            @if (isset($bItem['route']))
                                <a href="{{ route($bItem['route']) }}" class="text-muted text-hover-primary">{{ $bItem['label'] }}</a>
                            @else
                                {{ $bItem }}
                            @endif
                        </li>
